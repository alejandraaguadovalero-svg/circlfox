...
export const MOCK_EVENTS: Event[] = [
  { id: 1, title: 'City Bike Tour', description: 'Friendly game of volleyball as the sun sets. All skill levels welcome! Let\'s have some fun and then maybe grab a bite nearby.', imageUrl: 'https://images.unsplash.com/photo-1559348331-57d345336c32?q=80&w=2070&auto=format&fit=crop', date: '2025-03-01T12:00:00', location: 'City Hall', lat: 37.779, lng: -122.419, organizer: MOCK_USERS[2], attendeeIds: [2, 4, 3, 5, 6, 1], maxParticipants: 12, category: Category.SPORTS },
  { id: 2, title: 'Daniel in Football Match', description: 'Looking for 11 players for a friendly game on Saturday at the San Siro-Cantalejas field!', imageUrl: 'https://images.unsplash.com/photo-1552667466-07770ae110d0?q=80&w=2070&auto=format&fit=crop', date: '2025-03-03T12:00:00', location: 'Golden Gate Park', lat: 37.769, lng: -122.486, organizer: MOCK_USERS[3], attendeeIds: [3, 4], maxParticipants: 22, category: Category.SPORTS },
  { id: 3, title: 'Indie Band Showcase', description: 'Discover the next big thing in local music. A few cool indie bands are playing at The Underground. Come for the music, stay for the good vibes.', imageUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1974&auto=format&fit=crop', date: '2024-08-20T20:00:00', location: 'The Mission District', lat: 37.760, lng: -122.421, organizer: MOCK_USERS[2], attendeeIds: [3, 2], maxParticipants: 20, category: Category.MUSIC },
];

export const MOCK_EVENT_MESSAGES: Record<number, Message[]> = {
  1: [
    { id: 1, senderId: 3, text: "Hey everyone! So excited for the bike tour 🚴", timestamp: "2025-02-28T09:00:00" },
    { id: 2, senderId: 4, text: "Same! Should we bring water bottles?", timestamp: "2025-02-28T09:08:00" },
    { id: 3, senderId: 2, text: "Yes, and wear comfortable shoes. Route is ~12km", timestamp: "2025-02-28T09:15:00" },
    { id: 4, senderId: 5, text: "I'll be there! What time should we meet at the start?", timestamp: "2025-02-28T10:30:00" },
    { id: 5, senderId: 3, text: "Let's meet 10 min early at the main entrance 📍", timestamp: "2025-02-28T10:45:00" },
    { id: 6, senderId: 6, text: "Can't wait! I'll bring some snacks for the group 🍌", timestamp: "2025-02-28T11:00:00" },
  ],
  2: [
    { id: 1, senderId: 4, text: "Still looking for players! Tell your friends 🙌", timestamp: "2025-03-01T08:00:00" },
    { id: 2, senderId: 3, text: "I'm in! Confirming my spot now", timestamp: "2025-03-01T08:30:00" },
    { id: 3, senderId: 4, text: "Perfect, we need 8 more. Spread the word!", timestamp: "2025-03-01T08:35:00" },
  ],
};
